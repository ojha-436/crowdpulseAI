    ...
    <div className="space-y-6 max-w-4xl mx-auto animate-slide-up">
      ...
      <div className="bg-gradient-to-r from-midnight-800/80 to-midnight-700/60 border border-white/[0.06] rounded-3xl p-6 relative overflow-hidden flex flex-col md:flex-row items-center gap-6">
        ...
        <div className="text-center md:text-left flex-1 space-y-1">
          ...
          <p className="text-xs text-gray-500 font-mono">Operator Registered: {currentUser.joinedDate}</p>
        </div>
          ...
          <div className="bg-midnight-800/80 backdrop-blur-xl border border-white/[0.04] p-5 rounded-2xl">
            ...
            <div className="space-y-4">
              <div className="space-y-1">
                <p className="text-[10px] text-gray-500 font-mono uppercase">Terminal Access Level</p>
                <p className="text-sm font-bold text-white">{currentUser.clearance}</p>
              </div>
              <div className="h-px bg-white/[0.04]" />
              <div className="space-y-1">
                <p className="text-[10px] text-gray-500 font-mono uppercase">System Logins</p>
              ...
              <div className="h-px bg-white/[0.04]" />
              <div className="space-y-1">
                <p className="text-[10px] text-gray-500 font-mono uppercase">System Activity</p>
                <div className="flex items-center gap-1.5 mt-0.5">
                  <Award size={12} className="text-cyan-400" />
                  <span className="text-sm font-mono font-bold text-white">{currentUser.commandsCount} ActionsLogged</span>
                </div>
              </div>
            </div>
          </div>
            ...
            <form onSubmit={handleUpdate} className="space-y-5">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="space-y-1.5">
                  <label className="text-[10px] font-mono text-gray-400 tracking-wider uppercase">Display Name</label>
                  <input
                    type="text"
                    value={displayName}
                ...
                <div className="space-y-1.5">
                  <label className="text-[10px] font-mono text-gray-400 tracking-wider uppercase">Designation / Role</label>
                  <select
                    value={role}
                    ...
                    className="w-full px-4 py-2 bg-midnight-700/40 border border-white/[0.08] focus:border-pulse-400/50 rounded-xl text-sm text-white focus:outline-none transition-colors"
                  >
                    <option value="Stadium Director" className="bg-midnight-800">Stadium Director</option>
                    <option value="Security Chief" className="bg-midnight-800">Security Chief</option>
                    <option value="Operations Lead" className="bg-midnight-800">Operations Lead</option>
                    <option value="Operations Analyst" className="bg-midnight-800">Operations Analyst</option>
                  </select>
                </div>
              </div>
              ...
              <div className="space-y-2">
                <label className="text-[10px] font-mono text-gray-400 tracking-wider uppercase">Avatar Designation</label>
              ...
              <div className="space-y-1.5">
                <label className="text-[10px] font-mono text-gray-400 tracking-wider uppercase flex items-center gap-1.5">
                  <Key size={11} className="text-gray-500" />
