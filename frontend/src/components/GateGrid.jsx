...
export default function GateGrid({ gates, expanded }) {
  ...
  return (
    <div className="glass-card p-5">
      ...
      <div
        className={`grid gap-2 ${expanded ? "grid-cols-2 md:grid-cols-3 lg:grid-cols-4" : "grid-cols-2 lg:grid-cols-3"}`}
      >
            ...
            >
              ...
              <div className="space-y-1.5">
                ...
                <div className="flex items-center justify-between text-[11px]">
                  ...
                  <span
                    className={`font-mono ${gate.queueLength > 50 ? "text-warn-400" : "text-gray-300"}`}
                  >
                    {gate.queueLength}
                  </span>
                </div>
                <div className="flex items-center justify-between text-[11px]">
                  ...
                  <span className="font-mono text-gray-300">
                    {gate.avgProcessingTime.toFixed(0)}s
                  </span>
                </div>
              </div>
